		...
		<div class="opus-module-content">
			<p>
				...
				<template v-for="item in state.rich_text_nodes">
					...
					<a v-if="item.type === 'RICH_TEXT_NODE_TYPE_TOPIC'" :href="item.jump_url" class="opus-text-rich-hl topic"
					...
					<a v-if="item.type === 'RICH_TEXT_NODE_TYPE_WEB'" :href="(item as RichTextNodeWeb).jump_url" class="opus-text-rich-hl link"
					   target="_blank">{{ item.text }}</a>
					...
					<span v-if="item.type === 'RICH_TEXT_NODE_TYPE_OGV_SEASON'"
					      class="opus-text-rich-hl video">{{ item.text }}</span>
					<img v-if="item.type === 'RICH_TEXT_NODE_TYPE_EMOJI'" :alt="item.text" :src="(item as RichTextNodeEmoji).emoji.icon_url"
					...
					<div class="bili-dyn-card-live__header">
						...
						<div class="bili-dyn-card-live__cover b-img">
							<picture class="b-img__inner">
								<source :srcset="live.cover.avif" type="image/avif">
								<source :srcset="live.cover.webp" type="image/webp">
